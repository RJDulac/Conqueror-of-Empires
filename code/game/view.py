...
import code.game.isometric as isometric
import code.game.surface as surface
...
class PhysicalGame:
    ...
    def __init__(self, display, model, GUI):
        ...
        self.unit_health_text = pygame_gui.Text("", 15, (255, 255, 255), None, 0, 0)  # changed during unit drawing
    ...
    def draw_units(self):
        for unit in self.model.all_units():
            ...
            self.unit_health_text.y = y + constants.TILE_HEIGHT - 12
            # Drawing Unit
