...
import pygame_gui
import code.game.scroll as scroll
import code.game.view as view
...
class Message(MessageBase):
    ...
    def handle_click(self):
        if self.ok_button.check_clicked():
            self.GUI.delete_persistent()  # GUI is interface of code.gui.GameGui
...
class MiniMap:
    def __init__(self, model, visible=False):
        self.model_link = model
    ...
    def refresh(self):
        self.__init__(self.model_link, self.visible)
